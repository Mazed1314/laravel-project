            ...
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered mb-0">
                            <a class="float-right btn btn-primary btn-sm mr-2" href="{{route(currentUser().'.product.create')}}"style="font-size:1.7rem">Add</a>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <th scope="row">{{ ++$loop->index }}</th>
                                    ...
                                    <td class="white-space-nowrap">
                                        ...
                                        <a href="javascript:void()" onclick="$('#form{{$p->id}}').submit()" class="btn btn-danger btn-sm">
                                             Delete
                                        </a> 
