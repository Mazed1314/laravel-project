            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" action="{{route(currentUser().'.sale.update',encryptor('encrypt',$sale->id))}}">
                                @csrf
                                @method('patch')
                                ...
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  class="form-control form-select" name="customer_id" id="customer_id">
                                                    ...
                                                    @forelse($customers as $s)
                                                        <option value="{{$s->id}}" {{ old('customer_id',$sale->customer_id)==$s->id?"selected":""}}> {{ $s->customer_name}}</option>
                                                    @empty
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-select" name="product_id" id="product_id">
                                                ...
                                                @forelse($products as $p)
                                                    <option value="{{$p->id}}" {{ old('product_id',$sale->product_id)==$p->id?"selected":""}}> {{ $p->product_name}}</option>
                                                @empty
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly onkeyup="checkPrice()" id="price" class="form-control" value="{{$sale->price}}" placeholder="Price" name="price">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            <label for="quantity">'Quantity'</label>
                                            <input type="text" onkeyup="checkPrice()" id="quantity" class="form-control" value="{{$sale->quantity}}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeyup="checkPrice()" id="discount" class="form-control" value="{{$sale->discount}}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeyup="checkPrice()" id="vat" class="form-control" value="{{$sale->vat}}"
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="total_amount" class="form-control" value="{{$sale->total_amount}}"
